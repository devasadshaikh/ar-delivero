...
const SmallCard = (prop:IProps) => {
  return (
    <>
     <div className={` p-4 w-5/12 h-96 bg-white rounded-xl shadow-md shadow-slate-300 z-50  absolute ml-24   ${prop.pixels}`}>
     ...
     <Button className=' ml-5 mt-6  bg-[#D70F64]'>Get Started</Button>
